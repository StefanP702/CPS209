...
public class Address
{
	...
	public boolean equals(Object other)
	{
		...
		//$start compare the province, city, street, streetNumber, and apartment of this address and the other address otherA. If all are equal, return true
		// else return false. We will study the inherited equals method in class this week 
		if (province.equals(otherA.province) && city.equals(otherA.city) && street.equals(otherA.street) && streetNumber.equals(otherA.streetNumber) && apartment.equals(otherA.apartment) )
			return true;
		return false;
		//$end
	}
